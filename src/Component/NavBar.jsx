...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="fixed w-full  z-50 top-0 left-0 bg-[#000000] border-b border-[#333333]">
        <div className="max-w-[1720px] mx-auto px-4 sm:px-6 h-[76px] flex items-center justify-between">
          {/* Left: Logo */}
          <div className=" z-50">
            <Link to="/">
              <img
